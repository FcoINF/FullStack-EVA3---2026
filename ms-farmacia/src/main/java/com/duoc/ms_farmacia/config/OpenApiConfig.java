package com.duoc.ms_farmacia.config;
...
public class OpenApiConfig {
    ...
    public OpenAPI configurarOpenApi() {
        ...
        Info informacionApi = new Info()
                .title("Microservicio de Farmacia - RedSaludPatagónica")
                .description("""
                    API para la administración del stock
                    de medicamentos en postas rurales""")
                .version("1.0")
